...
.service('ZMDataModel',
['$http', '$q', '$ionicLoading', '$ionicBackdrop', '$rootScope', '$timeout', '$ionicPopup', '$localstorage', '$state','zm',
 function
 ($http, $q, $ionicLoading, $ionicBackdrop,
   $rootScope, $timeout,
   $ionicPopup, $localstorage, $state,zm) {
    ...
    var oldevents = [];
     ...
     var loginData = {
        ...
        'url': 'http://192.168.1.218/zm', // This is the ZM portal path
        'apiurl': 'http://192.168.1.218/zm/api', // This is the API path
        'eventServer':'', //experimental Event server address
        'maxMontage': "100", //total # of monitors to display in montage
        'streamingurl': "http://192.168.1.218/zm/cgi-bin",
     ...
     var loginDatademo = {
            ...
            'fallbackConfiguration': '',
            'url': 'https://demo.zoneminder.com/zm', // This is the ZM portal path
            'apiurl': 'https://demo.zoneminder.com/zm/api', // This is the API path
            'eventServer':'', //experimental Event server address
            'maxMontage': "100", //total # of monitors to display in montage
            'streamingurl': "https://demo.zoneminder.com/cgi-bin-zm",
            'maxFPS': "3", // image streaming FPS
            'montageQuality': "50", // montage streaming quality in %
            'singleImageQuality': "100", // single streaming quality in %
            'montageHistoryQuality':"50",
    ...
    return {
        ...
        {
            var d = $q.defer();
            if (loginData.serverName!="RANDOM")
            {
    ...
    //--------------------------------------------------------------------------
        ...
        // hemant : Hardcode for now need to fix it later
        monitorId=0;
        startTime="";
        endTime="";

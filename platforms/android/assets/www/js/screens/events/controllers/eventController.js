...
.controller('eventsController', ['$scope', '$rootScope', 'zm', 'ZMDataModel', 'message', '$ionicSideMenuDelegate', '$timeout', '$interval', '$ionicModal', '$ionicLoading', '$http', '$state', '$stateParams', '$ionicHistory', '$ionicScrollDelegate', '$ionicPlatform', '$ionicSlideBoxDelegate', '$ionicPosition', '$ionicPopover', '$ionicPopup', 'EventServer', '$sce', '$cordovaBadge', '$cordovaLocalNotification', '$q', 'appModalService',  function ($scope, $rootScope, zm, ZMDataModel, message, $ionicSideMenuDelegate, $timeout, $interval, $ionicModal, $ionicLoading, $http, $state, $stateParams, $ionicHistory, $ionicScrollDelegate, $ionicPlatform, $ionicSlideBoxDelegate, $ionicPosition, $ionicPopover, $ionicPopup, EventServer, $sce, $cordovaBadge, $cordovaLocalNotification, $q, appModalService) {
    ...
    $ionicPlatform.registerBackButtonAction(function (e) {
        ...
        function setupWatchers()
        {
            ...
            ionRangeWatcher = $scope.$watch('ionRange.index', function () {
              ...
              //hemant  if (carouselUtils.getStop() == true)
                   //hemant return;
                ...
                if ($scope.event && $scope.ionRange.index == parseInt($scope.event.Event.Frames) - 1) {
                    if (!$scope.modal || $scope.modal.isShown() == false) {
                       // console.log("quick scrub playback over");
                        //hemant carouselUtils.setStop(true);
 ...
 $ionicModal.fromTemplateUrl('js/screens/events/templates/events-modal.html', {
